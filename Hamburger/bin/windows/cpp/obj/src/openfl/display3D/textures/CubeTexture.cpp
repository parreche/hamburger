	...
	HX_STACK_ARG(miplevel,"miplevel")
{
		...
		HX_STACK_LINE(55)
		::openfl::_legacy::utils::UInt8Array source = ::openfl::_legacy::utils::UInt8Array_obj::__new(_g6,null(),null());		HX_STACK_VAR(source,"source");
		HX_STACK_LINE(60)
		{
			HX_STACK_LINE(60)
		...
		switch( (int)(side)){
			case (int)0: {
				...
				HX_STACK_LINE(66)
				::openfl::_legacy::utils::ByteArray _g7;		HX_STACK_VAR(_g7,"_g7");
				HX_STACK_LINE(66)
				if (((source == null()))){
					HX_STACK_LINE(66)
					_g7 = null();
				...
				HX_STACK_LINE(66)
				::openfl::_legacy::gl::GL_obj::lime_gl_tex_image_2d((int)34069,miplevel,(int)6408,width,height,(int)0,(int)6408,(int)5121,_g7,_g8);
			}
			;break;
			case (int)1: {
				HX_STACK_LINE(70)
				...
				int height = bitmapData->get_height();		HX_STACK_VAR(height,"height");
				HX_STACK_LINE(70)
				::openfl::_legacy::utils::ByteArray _g9;		HX_STACK_VAR(_g9,"_g9");
				HX_STACK_LINE(70)
				if (((source == null()))){
					HX_STACK_LINE(70)
					_g9 = null();
				...
				HX_STACK_LINE(70)
				::openfl::_legacy::gl::GL_obj::lime_gl_tex_image_2d((int)34070,miplevel,(int)6408,width,height,(int)0,(int)6408,(int)5121,_g9,_g10);
			}
			;break;
			case (int)2: {
				HX_STACK_LINE(74)
				...
				int height = bitmapData->get_height();		HX_STACK_VAR(height,"height");
				HX_STACK_LINE(74)
				::openfl::_legacy::utils::ByteArray _g11;		HX_STACK_VAR(_g11,"_g11");
				HX_STACK_LINE(74)
				if (((source == null()))){
					HX_STACK_LINE(74)
					_g11 = null();
				...
				HX_STACK_LINE(74)
				::openfl::_legacy::gl::GL_obj::lime_gl_tex_image_2d((int)34071,miplevel,(int)6408,width,height,(int)0,(int)6408,(int)5121,_g11,_g12);
			}
			;break;
			case (int)3: {
				HX_STACK_LINE(78)
				...
				int height = bitmapData->get_height();		HX_STACK_VAR(height,"height");
				HX_STACK_LINE(78)
				::openfl::_legacy::utils::ByteArray _g13;		HX_STACK_VAR(_g13,"_g13");
				HX_STACK_LINE(78)
				if (((source == null()))){
					HX_STACK_LINE(78)
					_g13 = null();
				...
				HX_STACK_LINE(78)
				::openfl::_legacy::gl::GL_obj::lime_gl_tex_image_2d((int)34072,miplevel,(int)6408,width,height,(int)0,(int)6408,(int)5121,_g13,_g14);
			}
			;break;
			case (int)4: {
				HX_STACK_LINE(82)
				...
				int height = bitmapData->get_height();		HX_STACK_VAR(height,"height");
				HX_STACK_LINE(82)
				::openfl::_legacy::utils::ByteArray _g15;		HX_STACK_VAR(_g15,"_g15");
				HX_STACK_LINE(82)
				if (((source == null()))){
					HX_STACK_LINE(82)
					_g15 = null();
				...
				HX_STACK_LINE(82)
				::openfl::_legacy::gl::GL_obj::lime_gl_tex_image_2d((int)34073,miplevel,(int)6408,width,height,(int)0,(int)6408,(int)5121,_g15,_g16);
			}
			;break;
			case (int)5: {
				HX_STACK_LINE(86)
				...
				int height = bitmapData->get_height();		HX_STACK_VAR(height,"height");
				HX_STACK_LINE(86)
				::openfl::_legacy::utils::ByteArray _g17;		HX_STACK_VAR(_g17,"_g17");
				HX_STACK_LINE(86)
				if (((source == null()))){
					HX_STACK_LINE(86)
					_g17 = null();
				...
				HX_STACK_LINE(86)
				::openfl::_legacy::gl::GL_obj::lime_gl_tex_image_2d((int)34074,miplevel,(int)6408,width,height,(int)0,(int)6408,(int)5121,_g17,_g18);
			}
			;break;
			default: {
				HX_STACK_LINE(90)
