...
{
HX_STACK_FRAME("openfl._legacy.display.OptimizedPerlin","new",0x2e02d39d,"openfl._legacy.display.OptimizedPerlin.new","openfl/_legacy/display/BitmapData.hx",970,0x0b92a012)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl._legacy.display.OptimizedPerlin","fill",0x0f2fa0a6,"openfl._legacy.display.OptimizedPerlin.fill","openfl/_legacy/display/BitmapData.hx",980,0x0b92a012)
		HX_STACK_THIS(this)
						...
						HX_STACK_LINE(1006)
						{
							...
							while((true)){
								...
								struct _Function_7_15{
									inline static Float Block( int &hash,Float &x,Float &y){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/_legacy/display/BitmapData.hx",1064,0x0b92a012)
										{
											HX_STACK_LINE(1064)
											return (  (((hash < (int)8))) ? Float(x) : Float(y) );
										}
...
{
		HX_STACK_FRAME("openfl._legacy.display.OptimizedPerlin","octFreqPers",0xaeeba70b,"openfl._legacy.display.OptimizedPerlin.octFreqPers","openfl/_legacy/display/BitmapData.hx",1094,0x0b92a012)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl._legacy.display.OptimizedPerlin","seedOffset",0xad5c4a47,"openfl._legacy.display.OptimizedPerlin.seedOffset","openfl/_legacy/display/BitmapData.hx",1117,0x0b92a012)
		HX_STACK_THIS(this)
