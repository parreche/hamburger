...
::PlayerInputRight_obj::__register();
::PlayerInputLeft_obj::__register();
::PlayerInput_obj::__register();
::IMap_obj::__register();
::List_obj::__register();
::Lambda_obj::__register();
::Ingredient_obj::__register();
...
::Ingredient_obj::__boot();
::Lambda_obj::__boot();
::List_obj::__boot();
::IMap_obj::__boot();
::PlayerInput_obj::__boot();
::PlayerInputLeft_obj::__boot();
::PlayerInputRight_obj::__boot();
::Reflect_obj::__boot();
