...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(25)
		::openfl::_legacy::Lib_obj::setPackage(HX_CSTRING("tomas"),HX_CSTRING("FlixelExample"),HX_CSTRING("FlixelExample"),HX_CSTRING("1.0.0"));
		...
		HX_STACK_LINE(41)
		::openfl::_legacy::Lib_obj::create( Dynamic(new _Function_1_1()),(int)800,(int)480,(int)60,(int)0,(int((int((int((int((int((int((int((int((int((int(::openfl::_legacy::Lib_obj::HARDWARE) | int(::openfl::_legacy::Lib_obj::ALLOW_SHADERS))) | int((int)0))) | int((int)0))) | int(::openfl::_legacy::Lib_obj::STENCIL_BUFFER))) | int(::openfl::_legacy::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("FlixelExample"),null(),null());
	}
return null();
}
